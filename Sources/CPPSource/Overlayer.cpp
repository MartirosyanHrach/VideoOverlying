...
Video Overlayer::overlay_videos(const Video& subtracted_background,
    ...
    auto min_frame_count = (subtracted_background.m_frame_count < moving_objects_video.m_frame_count) ? subtracted_background.m_frame_count : moving_objects_video.m_frame_count;
